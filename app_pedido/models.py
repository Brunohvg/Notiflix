...
class Pedido(models.Model):
    ...
    id_venda = models.CharField(
        max_length=20, verbose_name="ID Venda", blank=True, null=True
    )
    ...
    ultimo_status_notificado = models.CharField(
        max_length=100, verbose_name="Último Status Notificado", blank=True, null=True
    )
